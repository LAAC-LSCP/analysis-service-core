"""Word count model used as a fast, dependency-free model for testing."""
...
class WordCountModel(ModelPlugin):
    ...
    def run_model(
        ...
        """Write a word count file and a temporary date file for each input."""
    ...
    def postprocess(
        ...
        """Remove temporary date files from the output."""
        for file in pogroup:
